...
L["Force Slow Fall when in combat. This will obviously make Blink unavailable in combat."] = true;
L["For Death Knights it handles Wraith Walk when moving."] = true;
L["For Druids it handles aquatic, travel, flight and cat forms."] = true;
L["For Hunters it handles Aspect of the Cheetah."] = true;
L["For Mages it handles Blink when moving. Slow Fall when falling."] = true;
L["For Paladins it handles Divine Steed when moving."] = true;
L["For Priests it handles Body and Soul, Body and Mind and Angelic Feather when moving."] = true;
L["For Rogues it handles Sprint when moving."] = true;
L["For Shamans it handles Ghost Wolf when moving."] = true;
L["For Monks it handles Flying Serpent Kick and Roll when moving."] = true;
L["Select which modifier to use for cancelling Zen Flight."] = true;
L["For Warlocks it handles Burning Rush and Demonic Circle when moving."] = true;
...
L["Use a modifier to disable Burning Rush, this will also prevent the spell toggle."] = true;
L["Select which modifier to use for cancelling Burning Rush."] = true;
L["For Warriors it handles Heroic Leap when moving and out of combat. Charge and Intercept when in combat."] = true;
...
L["Force Levitate when in combat. This will obviously make Body and Soul, Body and Mind or Angelic Feather unavailable in combat."] = true;
...
L["Shadowmoon Valley (WoD)"] = true;
L["Nagrand (WoD)"] = true;
L["Shattrath City (WoD)"] = true;
L["Lunarfall (Main)"] = true;
L["Blasted Lands (WoD)"] = true;
L["Demonic Circle"] = true;
L["Select which modifier to use for casting Demonic Circle when out of combat."] = true;
L["\nBe aware that if a bind is set to the modifier plus the button bind this will not work."] = true;
L["Enable %s"] = true;
...
L["A newer version of Pets & Mounts is available. You have version %s revision %s %s, %s got version %s revision %s %s. Get it on Curse or with the Curse client."] = true;
